...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 25 23:15:06 2017
...
class MLPGradientCheck(object):
    ...
    def fit(self, X, y, print_progress=False):
        ...
        for i  in range(self.epochs):
            ...
            for idx in mini:
                ...
                ##check gradient
                grad_diff = self._gradient_check(X=X[idx],
                                                 y_enc=y_enc[:,idx],
                                                 w1=self.w1,
                                                 w2=self.w2,
                                                 epsilon=1e-5,
                                                 ...
                                                 grad2=grad2)
                if grad_diff < 1e-7:
                    print('OK: %.2e' % grad_diff)
                elif grad_diff < 1e-4:
                    print('Warning: %.2e' % grad_diff)
                else:
                    print('Problem: %.2e' % grad_diff)         
    ...
    def _gradient_check(self,X,y_enc,w1,w2,epsilon,grad1,grad2):
